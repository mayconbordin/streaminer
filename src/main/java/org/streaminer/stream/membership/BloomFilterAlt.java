 ...
 */
public class BloomFilterAlt<E> implements IFilter<E>, Serializable {
    ...
    /**
      ...
      */
    public BloomFilterAlt(double c, int n, int k) {
     ...
     */
    public BloomFilterAlt(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public BloomFilterAlt(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public BloomFilterAlt(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final BloomFilterAlt<E> other = (BloomFilterAlt<E>) obj;        

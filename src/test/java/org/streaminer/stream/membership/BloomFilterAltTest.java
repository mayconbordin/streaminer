...
/**
 * Tests for BloomFilterAlt.java
 *
 * @author Magnus Skjegstad <magnus@skjegstad.com>
 */
public class BloomFilterAltTest {
    static Random r = new Random();

    @Test
    public void testConstructorCNK() throws Exception {
        System.out.println("BloomFilterAlt(c,n,k)");

        for (int i = 0; i < 10000; i++) {
            double c = r.nextInt(20) + 1;
            int n = r.nextInt(10000) + 1;
            int k = r.nextInt(20) + 1;
            BloomFilterAlt bf = new BloomFilterAlt(c, n, k);
    ...
    /**
     * Test of createHash method, of class BloomFilterAlt.
     * @throws Exception
     */
    @Test
    public void testCreateHash_String() throws Exception {
        ...
        int result1 = BloomFilterAlt.createHash(val);
        int result2 = BloomFilterAlt.createHash(val);
        assertEquals(result2, result1);
        int result3 = BloomFilterAlt.createHash(UUID.randomUUID().toString());
        assertNotSame(result3, result2);

        int result4 = BloomFilterAlt.createHash(val.getBytes("UTF-8"));
    ...
    public void testCreateHashes_byteArr() throws UnsupportedEncodingException {
        ...
        String val = UUID.randomUUID().toString();
        byte[] data = val.getBytes("UTF-8");
        int[] result1 = BloomFilterAlt.createHashes(data, 10);
        int[] result2 = BloomFilterAlt.createHashes(data, 10);
        assertEquals(result1.length, 10);
        assertEquals(result2.length, 10);
        assertArrayEquals(result1, result2);
        int[] result3 = BloomFilterAlt.createHashes(data, 5);
    ...
    /**
     * Test of equals method, of class BloomFilterAlt.
     * @throws UnsupportedEncodingException
     */
    @Test
    public void testEquals() throws UnsupportedEncodingException {
        System.out.println("equals");
        BloomFilterAlt instance1 = new BloomFilterAlt(1000, 100);
        BloomFilterAlt instance2 = new BloomFilterAlt(1000, 100);
    ...
    /**
     * Test of hashCode method, of class BloomFilterAlt.
     * @throws UnsupportedEncodingException
     */
    @Test
    public void testHashCode() throws UnsupportedEncodingException {
        ...
        instance1 = new BloomFilterAlt(100, 10);
        instance2 = new BloomFilterAlt(100, 9);
        assertFalse(instance1.hashCode() == instance2.hashCode());

        instance1 = new BloomFilterAlt(100, 10);
        instance2 = new BloomFilterAlt(99, 9);
        assertFalse(instance1.hashCode() == instance2.hashCode());

        instance1 = new BloomFilterAlt(100, 10);
        instance2 = new BloomFilterAlt(50, 10);
        assertFalse(instance1.hashCode() == instance2.hashCode());
    }

    /**
     * Test of expectedFalsePositiveProbability method, of class BloomFilterAlt.
     */
    @Test
    public void testExpectedFalsePositiveProbability() {
        ...
        BloomFilterAlt instance = new BloomFilterAlt(1000, 100);
    ...
    /**
     * Test of clear method, of class BloomFilterAlt.
     */
    @Test
    ...
    /**
     * Test of add method, of class BloomFilterAlt.
     * @throws Exception
     */
    @Test
    ...
    public void testPercent() throws Exception {
        ...
        double p = instance.getPercentNonZero();
        System.out.println("Percent nonZero: " + p);
        assertTrue(p >= 0 && p <= 1);
    }

    /**
     * Test of addAll method, of class BloomFilterAlt.
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test of contains method, of class BloomFilterAlt.
     * @throws Exception
     */
    @Test
    public void testContains() throws Exception {
        System.out.println("contains");
        BloomFilterAlt instance = new BloomFilterAlt(10000, 10);
    ...
    /**
     * Test of containsAll method, of class BloomFilterAlt.
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test of getBit method, of class BloomFilterAlt.
     */
    @Test
    ...
    /**
     * Test of setBit method, of class BloomFilterAlt.
     */
    @Test
    ...
    /**
     * Test of size method, of class BloomFilterAlt.
     */
    @Test
    public void testSize() {
        System.out.println("size");
        for (int i = 100; i < 1000; i++) {
            BloomFilterAlt instance = new BloomFilterAlt(i, 10);
    ...
    public void testFalsePositiveRate1() throws UnsupportedEncodingException {
        ...
        for (int j = 10; j < 21; j++) {
            ...
            BloomFilterAlt instance = new BloomFilterAlt(100*j,100);
    ...
    public void testGetK() {
        ...
        BloomFilterAlt instance = null;

        instance = new BloomFilterAlt(2, 1);
        assertEquals(1, instance.getK());

        instance = new BloomFilterAlt(3, 1);
        assertEquals(2, instance.getK());

        instance = new BloomFilterAlt(4, 1);
        assertEquals(3, instance.getK());

        instance = new BloomFilterAlt(5, 1);
        assertEquals(3, instance.getK());

        instance = new BloomFilterAlt(6, 1);
        assertEquals(4, instance.getK());

        instance = new BloomFilterAlt(7, 1);
        assertEquals(5, instance.getK());

        instance = new BloomFilterAlt(8, 1);
        assertEquals(6, instance.getK());

        instance = new BloomFilterAlt(9, 1);
        assertEquals(6, instance.getK());

        instance = new BloomFilterAlt(10, 1);
        assertEquals(7, instance.getK());

        instance = new BloomFilterAlt(11, 1);
        assertEquals(8, instance.getK());

        instance = new BloomFilterAlt(12, 1);
        assertEquals(8, instance.getK());
    }
    ...
    public void testContains_GenericType() {
        System.out.println("contains");
        int items = 100;
        BloomFilterAlt<String> instance = new BloomFilterAlt(0.01, items);
    ...
    public void testContains_byteArr() {
        ...
        int items = 100;
        BloomFilterAlt instance = new BloomFilterAlt(0.01, items);
    ...
    /**
     * Test of count method, of class BloomFilterAlt.
     */
    @Test
    public void testCount() {
        System.out.println("count");
        int expResult = 100;
        BloomFilterAlt instance = new BloomFilterAlt(0.01, expResult);
        ...
        instance = new BloomFilterAlt(0.01, expResult);
        for (int i = 0; i < expResult; i++) {
